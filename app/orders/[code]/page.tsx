...
export default function OrderDetailsPage() {
  ...
  // Auto-refresh order every 3 seconds to keep progress bar updated
  useEffect(() => {
    if (!order || order.status === "Delivered" || order.status === "Cancelled") {
      return; // Don't poll if order is complete
    }
  ...
  }, [order?.status, params.code, API_BASE]);
          ...
          <div className="rounded-2xl bg-white/80 dark:bg-white/5 p-6 shadow">
            ...
            <div className="mt-6 mb-8">
              <div className="flex items-center justify-between mb-3">
                <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">Order Progress</div>
